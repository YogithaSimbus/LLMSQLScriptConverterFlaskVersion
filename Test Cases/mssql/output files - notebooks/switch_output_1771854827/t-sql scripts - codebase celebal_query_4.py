...
# MAGIC %md
# MAGIC # t-sql scripts - codebase celebal_query_4
# MAGIC This notebook was automatically converted from the script below. It may contain errors, so use it as a starting point and make necessary corrections.
# MAGIC
# MAGIC Source script: `/Volumes/lakebridge/switch/switch_volume/upload_1771854827/t-sql scripts - codebase celebal_query_4.sql`
